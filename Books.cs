    ...
    public partial class Books : Form
    {
        ...
        private void Save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = "INSERT INTO BookDb1 (BTitle, BAuthor, BCat, BQty, BPrice) VALUES ('" + BTitle.Text + "', '" + BAut.Text + "', '" + BCat.SelectedItem.ToString() + "', " + Qty.Text + ", " + Price.Text + ")";
        ...
        private void BCat_SelectedIndexChanged(object sender, EventArgs e)
        {
